...
#ifndef HUBER_LOSS_OP_H_
#define HUBER_LOSS_OP_H_
...
class HuberLossOp final : public Operator<Context> {
 public:
  HuberLossOp(const OperatorDef& operator_def, Workspace* ws)
...
template <typename T, class Context>
class HuberLossGradientOp final : public Operator<Context> {
 public:
  HuberLossGradientOp(const OperatorDef& def, Workspace* ws)

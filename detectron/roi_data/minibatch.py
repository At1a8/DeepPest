...
import detectron.roi_data.classification as classification_roi_data
...
def get_minibatch_blob_names(is_training=True):
    ...
    if cfg.RPN.RPN_ON:
        ...
        blob_names += classification_roi_data.get_classification_blob_names(
            is_training=is_training
        )
    else:
...
def get_minibatch(roidb):
    ...
    if cfg.RPN.RPN_ON:
        ...
        # for classification models
        valid = classification_roi_data.add_classification_blobs(

...
# Evaluator selection
__C.TEST.CITYSCAPES_EVALUATOR = False
__C.TEST.COCO_EVALUATOR = True
__C.TEST.VOC_EVALUATOR = False
...
# FPN finest level scale, which is used in FPN on other CNN backbones
__C.FPN.FINEST_LEVEL_SCALE = 0.25
...
__C.FPN.ROI_CANONICAL_LEVEL = 5  # k0: where s0 maps to
...
__C.FPN.RPN_ANCHOR_SIZE_INCREASE = 2.
